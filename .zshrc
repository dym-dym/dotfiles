...
export ZSH="/home/dymdym/.oh-my-zsh"
export PATH=$PATH:.
...
plugins=(git sudo zsh-autosuggestions zsh-vi-mode)
...
# opam configuration
test -r /home/dymdym/.opam/opam-init/init.zsh && . /home/dymdym/.opam/opam-init/init.zsh > /dev/null 2> /dev/null || true
